  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden font-sans bg-white">
      ...
      >
        {slides.map((slide, i) => (
          <SwiperSlide key={i}>
            <div className="flex flex-col md:flex-row items-center justify-between h-full max-w-7xl mx-auto px-6 md:px-12 gap-8 py-16">
              {/* Text Section */}
              <motion.div
              ...
              >
                <h1 className="text-5xl md:text-7xl font-bold font-mono text-gray-900">
                  {slide.title}
                </h1>
                <p className="text-gray-700 leading-relaxed">{slide.desc}</p>
      ...
      {/* 🔹 Short Titles Row */}
      <div className="absolute md:bottom-48 left-1/2 -translate-x-1/2 flex gap-6 z-50">
